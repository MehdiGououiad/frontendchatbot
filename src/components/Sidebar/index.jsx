              ...
              >
                ...
                <div className=" relative inline-block">
                  ...
                  {openMenuId === conversation.id && (
                    <div
                      className="absolute -right-2  mt-5 w-56 rounded-md shadow-lg bg-white z-20 ring-1 ring-black ring-opacity-5 focus:outline-none"
                      style={{ top: "100%" }}
                      role="menu"
                    ...
                    >
                      <div className="py-1" role="none">
                        ...
                        <a
                          ...
                          role="menuitem"
                          tabIndex="-1"
                          onClick={() => handleEditClick(conversation.id)}
                        >
  ...
  return (
    <div className="flex">
      <div
        ...
        className={`${
          isSidebarOpen ? " bg-white h-screen" : "hidden md:flex"
      ...
      >
        ...
        {/* <div className="flex justify-center mb-11 text-sm">
        <p>Dark Mode</p>
        <img src="toggle-dark.svg" className="mx-1" alt="" />
        <p>Light Mode</p>
        </div> */}
      </div>
